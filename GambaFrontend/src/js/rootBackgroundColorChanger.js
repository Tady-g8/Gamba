export default function rootBackgroundColorChanger() {
    ...
    root.style.setProperty('--color-secondary-darker', RGBToHSL1(r, g, b));
    root.style.setProperty('--color-primary-darker', RGBToHSL2(r, g, b));
}
